class FormValidator {
    ...
    disabledButtonAfterSubmit() {
        this._buttonSave.classList.remove(this._config.submitButtonSelector);
    ...
    _setEventListeners() {
        this._toggleButtonSituation(this._inputList, this._buttonSave);
